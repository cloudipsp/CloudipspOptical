...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/dNadiia/CloudipspOptical'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dNadiia' => 'nadiia.dovbysh@gmail.com' }
  s.source           = { :git => 'https://github.com/dNadiia/CloudipspOptical.git', :tag => s.version.to_s }
